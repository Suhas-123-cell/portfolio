...
/* ponytail: simple CSS float — no canvas/particle library */
    ...
    <CRTScreen>
      <div className="relative min-h-dvh flex flex-col items-center justify-center p-8 overflow-hidden" role="main">
        ...
        {FLOATS.map((glyph, i) => (
          <span
            key={i}
            className="absolute font-press-start select-none pointer-events-none"
            style={{
              left: `${5 + (i * 11) % 90}%`,
              top: `${8 + (i * 13) % 80}%`,
              fontSize: '10px',
        ...
        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }}
          ...
          <div className="mb-2 font-press-start text-[10px] sm:text-xs tracking-widest"
            style={{ color: 'oklch(35% 0.10 62)' }}>INSERT COIN TO CONTINUE</div>
