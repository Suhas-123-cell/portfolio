...
/* Hero art path — change this single value to swap your artwork */
...
const SOCIAL = [
  ...
  {
    label: 'LinkedIn',
    href: 'https://linkedin.com/in/suhas-chowdary',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4" aria-hidden="true">
            ...
            >
              <GlassPanel className="overflow-hidden project-card"
                ...
                <div className="p-4">
                  ...
                  <Link href={featured.demo ?? `/projects/${featured.slug}`}
                    target={featured.demo ? '_blank' : undefined}
                    rel={featured.demo ? 'noopener noreferrer' : undefined}
